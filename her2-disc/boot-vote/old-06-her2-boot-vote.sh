...
#SBATCH --job-name=her2-06
# Tell Gauss how much memory per CPU your job will use:
#SBATCH --mem=55120

# Standard out and Standard Error output files with the job number in the name.
#SBATCH -o /home/cconley/scratch-data/neta-metabric/disc-cv-vote/her2/06/logc.out
#SBATCH -e /home/cconley/scratch-data/neta-metabric/disc-cv-vote/her2/06/logc.err
...
/usr/bin/R --no-save --no-restore --no-site-file --no-init-file --args 31 < /home/cconley/repos/neta-metabric/her2-disc/06-her2-boot-vote.R
