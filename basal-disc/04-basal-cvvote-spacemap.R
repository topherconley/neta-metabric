...
tmap <- expand.grid(lam1 = exp(seq(log(60), log(70), length = 10)),
                    lam2 = seq(20^4, 29^4, length = 10)^(1/4),
                    lam3 = exp(seq(log(3), log(25), length = 10)))

#result directory
respath <- "/home/cconley/scratch-data/neta-metabric/disc-cv-vote/basal/04/"
...
save.image(file = file.path(respath, "basal-04.rda"))
stopCluster(cl)
