...
#GRID
tmap <- expand.grid(lam1 = seq(63, 78, length = 10),
                    lam2 = seq(15, 28, length = 16), 
                    lam3 = seq(0, 80, length= 16))
tmap <- tmap[!(tmap$lam2 < 23 & tmap$lam3 < 30),]
tmap <- tmap[!(tmap$lam2 > 22 & tmap$lam3 > 30),]


#result directory
respath <- "/home/cconley/scratch-data/neta-metabric/disc-cv-vote/basal/03/"
