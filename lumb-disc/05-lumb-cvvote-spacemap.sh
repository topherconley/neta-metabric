...
#SBATCH --job-name=LumB-04
# Tell Gauss how much memory per CPU your job will use:
#SBATCH --mem=30220

# Standard out and Standard Error output files with the job number in the name.
#SBATCH -o /home/cconley/scratch-data/neta-metabric/disc-cv-vote/lumb/04/log.out
#SBATCH -e /home/cconley/scratch-data/neta-metabric/disc-cv-vote/lumb/04/log.err
...
/usr/bin/R --no-save --no-restore --no-site-file --no-init-file --args 31 < /home/cconley/repos/neta-metabric/lumb-disc/04-lumb-cvvote-spacemap.R
